...
class IceHelper
{
     ...
     * @return bool|mixed
     */
    public function call(string $name, string $action, string $message, $option = [], $namespace = '\\app\\api\\ice')
    {
        ...
        return call_user_func([$namespace . '\\' . ucfirst($name), $action], $handle, $message);
    }

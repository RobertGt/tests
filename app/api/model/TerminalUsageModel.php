...
class TerminalUsageModel extends BaseModel
{
    ...
    public function getDetailTaskData(array $req = []):array
    {
        ...
        $getTerminalUsageDataDetailsReq->setPageNumber($params['pageNumber']);
        $getTerminalUsageDataDetailsReq->setCycleStartDate($params['cycleStartDate']);
    ...
    public function getTaskData(array $req = []):array
    {
        ...
        $getTerminalUsageReq->setCycleStartDate($params['cycleStartDate']);
        $requestInfo = new RequestInfo();
        $requestInfo->setBaseInfo($this->requestBase);
